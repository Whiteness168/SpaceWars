...
public class LevelManager : MonoBehaviour {
    ...
    [SerializeField] private GameObject _bonusSpawner;
    [SerializeField] private GameObject _alienSpawner;
    [SerializeField] private ScoreManager _scoreManager;
    [SerializeField] private int _targetScoreAmount;
    ...
    private bool CheckProgress() {
        if (_scoreManager.Score >= _targetScoreAmount && _levelControl == true) {
            _levelControl = false;
