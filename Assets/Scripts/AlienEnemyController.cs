...
public class AlienEnemyController : MonoBehaviour {
    ...
    [Space(10)] [SerializeField] private Vector3 _startPosition;

    [Space(10)] [SerializeField] private float _spacing;
    [Space(10)] [SerializeField] private float _rowSpacing;

    [Space(10)] [SerializeField] private int _numberOfRows;
    [Space(10)] [SerializeField] private int _numberOfShipsPerRow;
