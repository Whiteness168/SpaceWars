...
public class SpeedGameManager : MonoBehaviour {
    ...
    [SerializeField] private float _nextBoost;
    [SerializeField] private float _boostScrollBack;
    [SerializeField] private float _boostSpeedMeteor;
    [SerializeField] private float _boostSpawnDelay;
    [SerializeField] private float _boostSpeedPlayer;
    [SerializeField] private float _boostSpeedBonus;
